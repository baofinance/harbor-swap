...
///
///      Keeper calldata: Harbor Option A allowlist — only `OneInchV6Selectors.SWAP`
///      (`swap(address,tuple,bytes)`). Build via 1inch Swap API / Pathfinder; do not use
///      `unoswap`, `clipperSwap`, or `fillOrder` entrypoints unless the allowlist is expanded.
